...
const PAYPAL_VARIABLE_LABELS:Record<string,string>={orderNumber:"订单号",currentDate:"当前日期",recipientName:"收件人",address:"地址",phone:"电话",orderNotes:"订单备注",orderTotal:"订单总金额",currency:"币种",customerName:"客户名",customerPhone:"客户电话",productNames:"全部产品名",productQuantity:"产品数量",productName:"当前产品名",unitAmount:"当前单价",lineTotal:"当前小计"};
...
const PAYPAL_ITEM_VARIABLES=[...PAYPAL_GLOBAL_VARIABLES,"productName","unitAmount","lineTotal"];
