...
function WhatsAppAccountTransferDialog({sourceAccount,accounts,onClose,onTransfer}:{sourceAccount:ManagedAgent["accounts"][number];accounts:Account[];onClose:()=>void;onTransfer:(targetAccountId:string)=>Promise<void>}){
