...
type DraftProduct={id:string;mode:"library"|"new"|"legacy";productId:string|null;clientProductId:string|null;sku:string;name:string;quantity:string;unitAmount:string;weightAmount:string;weightUnit:WeightUnit;shippingClassId:string;shippingClassName:string;priceLocked:boolean;imageMediaId:string|null;imageName:string};
type DraftFee={id:string;name:string;amount:string};
const newDraftProduct=():DraftProduct=>({id:crypto.randomUUID(),mode:"new",productId:null,clientProductId:crypto.randomUUID(),sku:"",name:"",quantity:"1",unitAmount:"",weightAmount:"",weightUnit:"kg",shippingClassId:"",shippingClassName:"",priceLocked:false,imageMediaId:null,imageName:""});
