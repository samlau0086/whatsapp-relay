...
ALTER TABLE proactive_outreach_events ADD CONSTRAINT proactive_outreach_events_event_type_check CHECK(event_type IN ('planned','started','sent','skipped','cancelled','suppressed','restored','failed'));
