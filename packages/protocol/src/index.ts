...
export type ServerFrame = AgentCommand | { type: "ack"; cursor: number } | { type: "incompatible"; supportedVersion: number } | { type: "pong"; at: string } | { type:"attention_cleared"; accountId:string; chatJid:string } | { type:"account_removed"; accountId:string };
