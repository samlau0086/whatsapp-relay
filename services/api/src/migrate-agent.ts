...
export async function migrateAgentSchema():Promise<void>{
  for(const migration of ["014_ai_agent.sql","016_conversation_ai_takeover.sql","017_conversation_agent_modes.sql","018_ai_draft_chinese_translation.sql","019_contact_aliases.sql","020_order_templates.sql","021_order_template_defaults.sql","022_agent_provider_presets.sql"]){
