...
import { retryDatabaseStartup } from "./database-startup-retry.js";

export async function migrateAgentSchema():Promise<void>{
  await retryDatabaseStartup(migrateAgentSchemaOnce,{onRetry:(error,attempt,delayMs)=>console.warn("database unavailable during startup; retrying schema migration",{attempt,delayMs,code:String((error as {code?:unknown}).code??"")})});
}

async function migrateAgentSchemaOnce():Promise<void>{
  ...
  const channelMigrations=["055_messenger_channels.sql","056_channel_contact_search.sql","057_messenger_oauth.sql","058_shipping_templates.sql","059_shipping_destinations.sql","060_whatsapp_groups.sql","061_contact_business_location.sql","062_product_internal_pricing.sql","063_order_item_variant_snapshot.sql","064_contact_address_details.sql","065_message_comments.sql","066_paypal_profile_fees.sql","067_paypal_profile_fee_label.sql","068_conversation_failed_message_filter.sql","069_reply_suggestion_settings.sql","070_product_gallery.sql","071_order_internal_comment.sql","072_order_document_templates.sql","073_quotation_document_template.sql","074_order_tracking.sql","075_proactive_outreach.sql","076_account_quick_replies.sql","077_conversation_merge_links.sql","078_product_gallery_external_urls.sql","079_order_item_external_urls.sql","080_inquiry_order_template.sql","081_product_import_sources.sql","082_product_stock_status.sql","083_contact_whatsapp_username.sql","084_contact_provider_identity_optional.sql","085_contact_search_username_index.sql","086_paypal_profile_payment_term.sql","087_note_types.sql","088_task_execution_logs.sql","089_conversation_email.sql"];
