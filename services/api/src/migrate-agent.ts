...
async function migrateAgentSchemaOnce():Promise<void>{
  ...
  const channelMigrations=["055_messenger_channels.sql","056_channel_contact_search.sql","057_messenger_oauth.sql","058_shipping_templates.sql","059_shipping_destinations.sql","060_whatsapp_groups.sql","061_contact_business_location.sql","062_product_internal_pricing.sql","063_order_item_variant_snapshot.sql","064_contact_address_details.sql","065_message_comments.sql","066_paypal_profile_fees.sql","067_paypal_profile_fee_label.sql","068_conversation_failed_message_filter.sql","069_reply_suggestion_settings.sql","070_product_gallery.sql","071_order_internal_comment.sql","072_order_document_templates.sql"];
