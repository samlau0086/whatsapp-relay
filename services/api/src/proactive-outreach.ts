...
const audit=async(client:PoolClient,accountId:string,contactId:string,jobId:string|undefined,type:string,reason:string,plannedAt?:Date|string|null)=>client.query("INSERT INTO proactive_outreach_events(account_id,contact_id,job_id,event_type,reason,planned_at) VALUES($1,$2,$3,$4,$5,$6)",[accountId,contactId,jobId??null,type,reason,plannedAt??null]);
