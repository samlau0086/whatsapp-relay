...
ipcMain.handle("agent:state", () => ({baseUrl:"https://relay.test",enrolled:true,connection:"online",version:"smoke",protocolVersion:1,accounts:[],proxy:{mode:"auto",url:"",effective:"系统代理：127.0.0.1:7897"}}));
